...
void ClimateControlChannelOwnerModule::initialize(uint8_t numberOfChannels)
{
...
ClimateControlChannelOwnerModule::~ClimateControlChannelOwnerModule()
{
...
/*
    ...
    */
void ClimateControlChannelOwnerModule::setup(bool configured)
{
    OpenKNX::Module::setup(configured);
}

OpenKNX::Channel* ClimateControlChannelOwnerModule::createChannel(uint8_t _channelIndex /* this parameter is used in macros, do not rename */)
{
    return nullptr;
}

void ClimateControlChannelOwnerModule::setup()
{
...
/*
    ...
    */
void ClimateControlChannelOwnerModule::loop(bool configured)
{
...
OpenKNX::Channel* ClimateControlChannelOwnerModule::getChannel(uint8_t channelIndex)
{
    return _pChannels != nullptr ? _pChannels[channelIndex] : nullptr;
}

uint8_t ClimateControlChannelOwnerModule::getNumberOfChannels()
{
    return _numberOfChannels;
}

uint8_t ClimateControlChannelOwnerModule::getNumberOfUsedChannels()
{
...
void ClimateControlChannelOwnerModule::loop()
{
    OpenKNX::Module::loop();
    if (_pChannels != nullptr)
    {
...
/*
    ...
    */
void ClimateControlChannelOwnerModule::setup1(bool configured)
{
...
void ClimateControlChannelOwnerModule::setup1()
{
...
/*
    ...
    */
void ClimateControlChannelOwnerModule::loop1(bool configured)
{
...
void ClimateControlChannelOwnerModule::loop1()
{
...
/*
    ...
    * @param GroupObject
    */
void ClimateControlChannelOwnerModule::processInputKo(GroupObject &ko)
{
